...
export const OrderSummary = (props) => {
	return (
		<div className="text-center mt-5">
            ...
            <h1 className='about-title'> Your Order Will Ship According to the Following Info</h1>
			<br />
            <div classname='demo-address-container'>
                <h1>Lauren Covington</h1>
            ...
            <div classname='contributor-container'>
                <h1>Farmer(s) Who Contributed to Your Order</h1>
                <img src='https://images.unsplash.com/photo-1481555716071-8830d3e254ba?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1650&q=80' alt='McDowell farm and tractor pictured'/>
            ...
            <br />
            <br />
			<h2>Need to Change the Delivery Location?</h2>
			<br />
			...
			<a href='https://www.gmail.com'>
                <button>Shoot your NPO Rep An Email!</button>
            </a>
			<br />
			<br />
